...
// For Paning around object (only works with mouse)

// // set the target point to be the center of the object
// controls.target.copy(model.position);

// // enable panning and rotating
...
//model 
let playButtonMesh, nextButtonMesh, previousButtonMesh, displayMesh;
